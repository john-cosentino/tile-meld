...
export function Table({
  ...
  return (
    <div className="stack">
      ...
      {/* Wide arcade playfield: sets wrap into a responsive grid on the
          enlarged board instead of stacking one per row -- purely a
          presentational container, TableSet/DropZone geometry and drag/
