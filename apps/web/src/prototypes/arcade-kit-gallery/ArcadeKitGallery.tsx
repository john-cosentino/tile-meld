  ...
  return (
    <main className="kit-gallery arcade-scanlines">
          ...
          <section key={font.label} className="kit-gallery-font-card">
            ...
            {FONT_SAMPLES.map((sample) => (
              <p
                ...
                className="kit-gallery-font-sample"
              >
                {sample}
              </p>
            ))}
      ...
      <div className="kit-gallery-row">
        ...
        />
        <ArcadePlate
          plate="plate-action-dim"
          icon="icon-sort-tiles"
          label="Sort"
          sublabel="Sort rack"
        />
        <ArcadePlate
          ...
          label="Commit Turn"
          sublabel="Lock in your moves"
        />
        <ArcadePlate
          plate="plate-action-cyan"
          icon="icon-draw-stack"
          label="Disabled state"
          sublabel="Not your turn"
          disabled
        />
      </div>
      ...
      <div className="kit-gallery-row">
        <div
          style={{ ...frameStyle("badge-signed-in"), padding: "0.4rem 1rem" }}
          className="kit-gallery-badge"
        >
          Signed in — {LONG_NAME}
        </div>
