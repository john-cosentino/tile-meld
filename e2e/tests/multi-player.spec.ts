...
import { startNPlayerGame } from "./helpers.js";
...
// (join-by-code, ready-up, start, seat assignment, turn handoff) scales
// past 2 seats, not just that it works for exactly 2.
